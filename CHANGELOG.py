...
[FIX] 033 - diff_033 - Ajustes de robustez e validações no db.h" (server/metin2/Source/Server/game/src/db.h);
[FIX] 034 - diff_034 - Sanity-check de packets/inputs para bloquear dados malformados no login/input (server/metin2/Source/Server/game/src/char.h, server/metin2/Source/Server/game/src/char.cpp (+1));
[FIX] 035 - diff_035 - Ajustes de robustez e validações no entity.cpp" (server/metin2/Source/Server/game/src/entity.cpp);
[FIX] 036 - diff_036 - Ajustes de robustez e validações no GrpDetector.cpp" (src-client/Client/EterLib/GrpDetector.cpp);
[FIX] 037 - diff_037 - Ajustes de robustez e validações no SoundManager.cpp" (src-client/Client/MilesLib/SoundManager.cpp);
[FIX] 038 - diff_038 - Sanity-check de packets/inputs para bloquear dados malformados no char_item (server/metin2/Source/Server/game/src/char_item.cpp);
[FIX] 039 - diff_039 - Clamp do tamanho do nome de flag para evitar overflow/strings inválidas no quest system (server/metin2/Source/Server/game/src/char.h, server/metin2/Source/Server/game/src/char.cpp (+1));
[FIX] 040 - diff_040 - Clamps/validações contra over/underflow no GrpTextInstance (src-client/Client/EterLib/GrpTextInstance.cpp, src-client/Client/EterLib/GrpTextInstance.h (+1));
