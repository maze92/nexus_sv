...
namespace FoxFS
{
	// Normaliza paths para bater com os nomes guardados no pack:
	// - lowercase
	// - '\\' -> '/'
	// - remove prefixos tipo "D:/Ymir Work/" (ou qualquer drive + /ymir work/)
	// - resolve fonts: "tahoma:12.fnt" -> "tahoma.fnt"
	static inline void NormalizeFoxPath(std::string& fn)
	{
		...
		// strip "x:/ymir work/" (case-insensitive já está lower)
		...
		{
			// também aceita sem drive: "ymir work/..."
